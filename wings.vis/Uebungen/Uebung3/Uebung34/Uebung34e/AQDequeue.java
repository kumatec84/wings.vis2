...
public class AQDequeue extends AQApplication {
	 ...
	 *                                  encounters any error while using the Java AQ
	 *                                  API
	...
	protected void doTest(NativeAQ aq) throws AQException, SQLException {
		...
		AQQueue queue = aq.session.getQueue(DB_AQ_ADMIN_NAME, // Queue owner
		...
		AQMessage message = ((AQOracleQueue) queue).dequeue(dequeueOption, // Options and paramters to dequeue
